...
![](./assets/01-编程语言和JavaScript简介/image-20230820183113674.png)
...
![image-20231001002948987](./assets/01-编程语言和JavaScript简介/202310010029086.png)
...
- **汇编语言**：与机器语言实质是相同的，都是直接对硬件操作(需要汇编程序翻译），只不过指令采用了英文缩写的标识符，容易识别和记忆。
...
![20211030-0031-2](./assets/01-编程语言和JavaScript简介/20211030-0031-2.png)

（上方图片来源：[JavaScript 基础-基本概念](https://www.jianshu.com/p/230093183f47) ）

![20211030-0026-2](./assets/01-编程语言和JavaScript简介/20211030-0026-2.png)
...
<img src="./assets/01-编程语言和JavaScript简介/Netscape Navigator.jpg" alt="20211030-0026-2" style="zoom: 67%;" />

JavaScript 诞生于**1995 年**，是由**网景**公司（Netscape）的员工 Brendan Eich（兰登 • 艾奇，1961 年～）发明，最初命名为 LiveScript。1995 年 12 月与 SUN 公司合作，因市场宣传需要，为了蹭 Java 的热度，改名为 JavaScript。

<img src="./assets/01-编程语言和JavaScript简介/Brendan Eich.png" alt="20211030-0026-2" style="zoom: 33%;" />
...
<img src="./assets/01-编程语言和JavaScript简介/周杰伦.jpg" alt="20211030-0026-2" style="zoom: 50%;" /><img src="./assets/01-编程语言和JavaScript简介/zhoujie.jpg" alt="20211030-0026-2" style="zoom: 50%;" />
...
<img src="./assets/01-编程语言和JavaScript简介/ecma.jpg" alt="20211030-0026-2" style="zoom: 50%;" />
...
<img src="./assets/01-编程语言和JavaScript简介/你办事我放心.png" alt="20211030-0026-2" style="zoom: 40%;" />
...
<img src="./assets/01-编程语言和JavaScript简介/Image.png" alt="20211030-0026-2" style="zoom: 50%;" />
...
- 什么是脚本语言？
  ...
  脚本就是剧本，浏览器是演员。凡是不能独立运行，需要依赖其他环境运行的叫脚本。Js在html中运行，HTML文件必须在浏览器里执行。JS文件嵌入到HTML文件里才能执行。

<img src="./assets/01-编程语言和JavaScript简介/脚本语言.png" alt="20211030-0026-2" style="zoom: 50%;" />
...
**页面三要素**结构：HTML  表现：CSS  行为：JS  

H5是一种新的技术，就目前而言，我们所知的H5都是一些标签，但是有了JS之后，这些标签深层的扩展功能才得以实现。 

比如video标签；我们对其理解为一个简单的标签；但是实际上，video标签还有更深层次的扩展功能；js可以控制html。
...
<img src="./assets/01-编程语言和JavaScript简介/0964c49a88040dc69666487c6cbb6159d0dfd7e0.png" alt="20211030-0026-2" style="zoom: 100%;" />

- [编程语言70年：谁是世界上最好的编程语言？](https://zhuanlan.zhihu.com/p/611924622)

<img src="./assets/01-编程语言和JavaScript简介/v2-fcdbef5c589522df3960e4cea9825a71_1440w.png" alt="20211030-0026-2" style="zoom: 100%;" />
